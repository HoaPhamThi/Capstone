...
export const setAccessToken = (accessToken) => {
    ...
    document.cookie = `CAS_accessToken=${accessToken};${expires};path=/;${window.location.protocol === 'https' ? 'secure;' : ''}`;
};
...
export const logOut = () => {
    document.cookie = 'CAS_accessToken=; Max-Age=-99999999;';
};
